    ...
    for split_id, seed in enumerate(SEEDS, start=1):
        ...
        for regime_name in ['plain', 'H1', 'H2']:
            ...
            for i in range(len(y_test)):
                ...
                out = morphogenetic_consensus_one(band_logits0=l0, frozen_flags=frozen_flags, band_weights0=w0, alpha=0.3, lam=1.0, T=0.01, tau=0.05, max_iter=30, use_js=True, return_trajectories=False, record_stress=False, regime=regime_name, local_coupling=True, mute_weight=0.0, diff_amp=0.25, weight_clip=(0.0, 5.0), rng=np.random.default_rng(seed + i))
